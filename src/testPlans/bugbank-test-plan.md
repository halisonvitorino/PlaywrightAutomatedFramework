...
- Passos:
  ...
  3. Preencher o campo "E-mail"
  4. Preencher o campo "Senha"
  5. Preencher o campo "Confirmar Senha"
...
_Plano de Testes criado baseado na história de usuário em `user-stories/signUp_feature.md`_
_Data de criação: $(date)_
_Última revisão: $(date)_
